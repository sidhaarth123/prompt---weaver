    ...
    return (
        <div className="min-h-screen bg-[#05060b] text-white selection:bg-cyan-500/20 font-sans">
            ...
            <main className="pt-24 pb-20">
                ...
                <section id="json" className="py-32 scroll-mt-20">
                ...
                <section id="image" className="container mx-auto px-6 py-40 border-t border-white/5 scroll-mt-20">
                ...
                <section id="video" className="container mx-auto px-6 py-40 border-t border-white/5 scroll-mt-20">
